...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; margin-bottom: 30px; padding: 0 20px;">
    <div>
        <h2 class="page-title" style="margin-bottom: 5px; text-align: left;">Pro Gaming Gear</h2>
        <p style="color: var(--text-muted);">Equip yourself with the best in the industry</p>
    </div>
...
<div class="products-grid">
    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <a href="<?php echo BASE_URL; ?>cart_action.php?action=add&id=<?php echo $row['id']; ?>" class="btn-primary" style="display: block; text-align: center; text-decoration: none; box-sizing: border-box; margin-bottom: 10px;">Buy Now</a>
            <a href="<?php echo BASE_URL; ?>cart_action.php?action=add&id=<?php echo $row['id']; ?>" style="display: block; text-align: center; text-decoration: none; width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: white; cursor: pointer; transition: 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='rgba(255,255,255,0.05)'">
                Add to Cart
            </a>
        </div>
    </div>
    <?php
        ...
        echo "<h3 style='color: white; margin-bottom: 10px;'>No gear found</h3>";
        echo "<p style='color: var(--text-muted);'>We are currently restocking our elite inventory. Please check back later.</p>";
        echo "</div>";
    }
    ?>
</div>
