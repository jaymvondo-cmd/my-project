...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
    <h2 class="page-title" style="margin-bottom: 0;">All Products</h2>
    <a href="add_product.php" class="btn-primary" style="width: auto; text-decoration: none; padding: 10px 20px;">+ Add Product</a>
</div>
...
<div class="products-grid">
    ...
    <?php
        ...
        echo "<p style=\"grid-column: 1/-1; text-align: center; color: var(--text-muted);\">No products found. Start by adding a product.</p>";
    }
    ?>
</div>
